...
const cleanBathroom = person => {
  return `${person.firstName} ${person.lastName} will clean the bathroom`;
};

const laundry = person => {
  return `${person.firstName} ${person.lastName} will do the laundry`;
};

const cleanRoom = person => {
  return `${person.firstName} ${person.lastName} will clean their room`;
};

const takeOutTrash = person => {
  return `${person.firstName} ${person.lastName} will take out the trash`;
};

const vacuum = person => {
  return `${person.firstName} ${person.lastName} will vacuum`;
};

const cleanWindows = person => {
  return `${person.firstName} ${person.lastName} will clean the windows`;
};
...
console.log(dayPlanner(cleanWindows, person, "Wednesday"));
